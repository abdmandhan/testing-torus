...
var NETWORK_MAP = (_NETWORK_MAP = {}, _defineProperty(_NETWORK_MAP, TORUS_NETWORK.MAINNET, "mainnet"), _defineProperty(_NETWORK_MAP, TORUS_NETWORK.TESTNET, "goerli"), _defineProperty(_NETWORK_MAP, TORUS_NETWORK.CYAN, "polygon-mainnet"), _defineProperty(_NETWORK_MAP, TORUS_NETWORK.AQUA, "polygon-mainnet"), _defineProperty(_NETWORK_MAP, TORUS_NETWORK.CELESTE, "polygon-mainnet"), _NETWORK_MAP);
var abi = [{
  inputs: [{
    internalType: "string",
    name: "_verifier",
  ...
  _createClass(NodeDetailManager, [{
    ...
    value: function () {
      var _getNodeDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref2) {
        var verifier, verifierId, hashedVerifierId, nodeDetails, currentEpoch, torusNodeEndpoints, torusNodePubX, torusNodePubY, torusIndexes, updatedEndpoints, updatedNodePub, index, endPointElement, pubKx, pubKy, endpoint;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                if (!(this.updated && (this.nodeListAddress === NodeDetailManager.PROXY_ADDRESS_MAINNET || this.nodeListAddress === NodeDetailManager.PROXY_ADDRESS_TESTNET))) {
                  _context.next = 4;
                  break;
                }
...
_defineProperty(NodeDetailManager, "PROXY_ADDRESS_TESTNET", "0xd084604e5FA387FbC2Da8bAab07fDD6aDED4614A");
_defineProperty(NodeDetailManager, "PROXY_ADDRESS_CYAN", "0x9f072ba19b3370e512aa1b4bfcdaf97283168005");
_defineProperty(NodeDetailManager, "PROXY_ADDRESS_AQUA", "0x29Dea82a0509153b91040ee13cDBba0f03efb625");
_defineProperty(NodeDetailManager, "PROXY_ADDRESS_CELESTE", "0x6Bffb4e89453069E7487f0fa5c9f4a2D771cce6c");
...
export { NETWORK_MAP, TORUS_NETWORK, abi, NodeDetailManager as default };
