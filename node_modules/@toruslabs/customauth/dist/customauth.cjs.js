...
var CONTRACT_MAP = (_CONTRACT_MAP = {}, defineProperty_default()(_CONTRACT_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.MAINNET, (fetch_node_details_default()).PROXY_ADDRESS_MAINNET), defineProperty_default()(_CONTRACT_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.TESTNET, (fetch_node_details_default()).PROXY_ADDRESS_TESTNET), defineProperty_default()(_CONTRACT_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.CYAN, (fetch_node_details_default()).PROXY_ADDRESS_CYAN), defineProperty_default()(_CONTRACT_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.AQUA, (fetch_node_details_default()).PROXY_ADDRESS_AQUA), defineProperty_default()(_CONTRACT_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.CELESTE, (fetch_node_details_default()).PROXY_ADDRESS_CELESTE), _CONTRACT_MAP);
var SIGNER_MAP = (_SIGNER_MAP = {}, defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.MAINNET, "https://signer.tor.us"), defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.TESTNET, "https://signer.tor.us"), defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.CYAN, "https://signer-polygon.tor.us"), defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.AQUA, "https://signer-polygon.tor.us"), defineProperty_default()(_SIGNER_MAP, fetch_node_details_namespaceObject.TORUS_NETWORK.CELESTE, "https://signer-polygon.tor.us"), _SIGNER_MAP);
var SENTRY_TXNS = {
...
var loginToConnectionMap = (_loginToConnectionMap = {}, defineProperty_default()(_loginToConnectionMap, LOGIN.APPLE, "apple"), defineProperty_default()(_loginToConnectionMap, LOGIN.GITHUB, "github"), defineProperty_default()(_loginToConnectionMap, LOGIN.LINKEDIN, "linkedin"), defineProperty_default()(_loginToConnectionMap, LOGIN.TWITTER, "twitter"), defineProperty_default()(_loginToConnectionMap, LOGIN.WEIBO, "weibo"), defineProperty_default()(_loginToConnectionMap, LOGIN.LINE, "line"), defineProperty_default()(_loginToConnectionMap, LOGIN.EMAIL_PASSWORD, "Username-Password-Authentication"), defineProperty_default()(_loginToConnectionMap, LOGIN.PASSWORDLESS, "email"), _loginToConnectionMap);
...
function are3PCSupported() {
  ...
  if (browserInfo.engine.name === external_bowser_namespaceObject.ENGINE_MAP.WebKit || browserInfo.engine.name === external_bowser_namespaceObject.ENGINE_MAP.Gecko) {
    thirdPartyCookieSupport = false;
  }
        ...
        return new Promise(function (resolve, reject) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _ref2 = data || {}, instanceParams = _ref2.instanceParams, _ref2$hashParams = _ref2.hashParams, accessToken = _ref2$hashParams.access_token, idToken = _ref2$hashParams.id_token, rest = objectWithoutProperties_default()(_ref2$hashParams, _excluded);
                      if (!error) {
                        _context.next = 7;
                        break;
                      }
          ...
          if (!_this.redirectToOpener) {
            ...
            var postMessageEventHandler = /*#__PURE__*/function () {
              var _ref4 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(postMessageEvent) {
                var ev;
...
function DiscordHandler_createSuper(Derived) { var hasNativeReflectConstruct = DiscordHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function DiscordHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var DiscordHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  createClass_default()(DiscordHandler, [{
    ...
    key: "getUserInfo",
    value: function () {
      var _getUserInfo = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(params) {
        var accessToken, userInfo, id, avatar, _userInfo$email, email, _userInfo$username, name, _userInfo$discriminat, discriminator, profileImage;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 3:
                ...
                id = userInfo.id, avatar = userInfo.avatar, _userInfo$email = userInfo.email, email = _userInfo$email === void 0 ? "" : _userInfo$email, _userInfo$username = userInfo.username, name = _userInfo$username === void 0 ? "" : _userInfo$username, _userInfo$discriminat = userInfo.discriminator, discriminator = _userInfo$discriminat === void 0 ? "" : _userInfo$discriminat;
                profileImage = avatar === null ? "https://cdn.discord.com/embed/avatars/".concat(Number(discriminator) % 5, ".png") : "https://cdn.discord.com/avatars/".concat(id, "/").concat(avatar, ".png?size=2048");
                return _context.abrupt("return", {
...
function FacebookHandler_createSuper(Derived) { var hasNativeReflectConstruct = FacebookHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function FacebookHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                userInfo = _context.sent;
                _userInfo$name = userInfo.name, name = _userInfo$name === void 0 ? "" : _userInfo$name, id = userInfo.id, picture = userInfo.picture, _userInfo$email = userInfo.email, email = _userInfo$email === void 0 ? "" : _userInfo$email;
                return _context.abrupt("return", {
                  email: email,
                  name: name,
...
function GoogleHandler_createSuper(Derived) { var hasNativeReflectConstruct = GoogleHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function GoogleHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                userInfo = _context.sent;
                _userInfo$picture = userInfo.picture, profileImage = _userInfo$picture === void 0 ? "" : _userInfo$picture, _userInfo$email = userInfo.email, email = _userInfo$email === void 0 ? "" : _userInfo$email, _userInfo$name = userInfo.name, name = _userInfo$name === void 0 ? "" : _userInfo$name;
                return _context.abrupt("return", {
                  email: email,
                  name: name,
                  profileImage: profileImage,
...
function JwtHandler_createSuper(Derived) { var hasNativeReflectConstruct = JwtHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function JwtHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var JwtHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  createClass_default()(JwtHandler, [{
    ...
    value: function () {
      var _getUserInfo = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(params) {
        var idToken, accessToken, _this$jwtParams, domain, verifierIdField, isVerifierIdCaseSensitive, _this$jwtParams$user_, user_info_route, domainUrl, userInfo, picture, name, email, decodedToken, _name, _email, _picture;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                idToken = params.idToken, accessToken = params.accessToken;
                _this$jwtParams = this.jwtParams, domain = _this$jwtParams.domain, verifierIdField = _this$jwtParams.verifierIdField, isVerifierIdCaseSensitive = _this$jwtParams.isVerifierIdCaseSensitive, _this$jwtParams$user_ = _this$jwtParams.user_info_route, user_info_route = _this$jwtParams$user_ === void 0 ? "userinfo" : _this$jwtParams$user_;
                if (!accessToken) {
                  _context.next = 15;
                  break;
                }
...
function MockLoginHandler_createSuper(Derived) { var hasNativeReflectConstruct = MockLoginHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function MockLoginHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
function PasswordlessHandler_createSuper(Derived) { var hasNativeReflectConstruct = PasswordlessHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function PasswordlessHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var PasswordlessHandler_JwtHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  createClass_default()(JwtHandler, [{
    ...
    value: function () {
      var _getUserInfo = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(params) {
        var idToken, accessToken, _this$jwtParams, domain, verifierIdField, isVerifierIdCaseSensitive, domainUrl, userInfo, picture, name, email, decodedToken, _name, _email, _picture;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                idToken = params.idToken, accessToken = params.accessToken;
                _this$jwtParams = this.jwtParams, domain = _this$jwtParams.domain, verifierIdField = _this$jwtParams.verifierIdField, isVerifierIdCaseSensitive = _this$jwtParams.isVerifierIdCaseSensitive;
                _context.prev = 2;
                domainUrl = new URL(domain);
                _context.next = 6;
    ...
    value: function handleLoginWindow() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        try {
          ...
          (0,http_helpers_namespaceObject.post)(_this2.finalURL.href, JSON.parse(JSON.stringify(finalJwtParams))).then(function (response) {
...
function RedditHandler_createSuper(Derived) { var hasNativeReflectConstruct = RedditHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function RedditHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                userInfo = _context.sent;
                _userInfo$icon_img = userInfo.icon_img, profileImage = _userInfo$icon_img === void 0 ? "" : _userInfo$icon_img, _userInfo$name = userInfo.name, name = _userInfo$name === void 0 ? "" : _userInfo$name;
                return _context.abrupt("return", {
                  email: "",
                  name: name,
...
function TwitchHandler_createSuper(Derived) { var hasNativeReflectConstruct = TwitchHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function TwitchHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var TwitchHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  createClass_default()(TwitchHandler, [{
    ...
    value: function () {
      var _getUserInfo = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(params) {
        var accessToken, userInfo, _ref, _ref2, _ref2$, _ref2$$profile_image_, profileImage, _ref2$$display_name, name, _ref2$$email, email, verifierId;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 3:
                userInfo = _context.sent;
                _ref = userInfo.data || [], _ref2 = slicedToArray_default()(_ref, 1), _ref2$ = _ref2[0], _ref2$$profile_image_ = _ref2$.profile_image_url, profileImage = _ref2$$profile_image_ === void 0 ? "" : _ref2$$profile_image_, _ref2$$display_name = _ref2$.display_name, name = _ref2$$display_name === void 0 ? "" : _ref2$$display_name, _ref2$$email = _ref2$.email, email = _ref2$$email === void 0 ? "" : _ref2$$email, verifierId = _ref2$.id;
                return _context.abrupt("return", {
                  profileImage: profileImage,
                  name: name,
                  email: email,
...
function WebAuthnHandler_createSuper(Derived) { var hasNativeReflectConstruct = WebAuthnHandler_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = getPrototypeOf_default()(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = getPrototypeOf_default()(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return possibleConstructorReturn_default()(this, result); }; }
function WebAuthnHandler_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); return true; } catch (e) { return false; } }
...
var WebAuthnHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  createClass_default()(WebAuthnHandler, [{
    ...
    key: "getUserInfo",
    value: function () {
      var _getUserInfo = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(parameters) {
        var idToken, ref, extraParamsPassed, extraParams, verifierId, signature, clientDataJSON, authenticatorData, publicKey, challenge, rpOrigin, credId, transports, _JSON$parse, _yield$get, _yield$get2;
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                idToken = parameters.idToken, ref = parameters.ref, extraParamsPassed = parameters.extraParamsPassed, extraParams = parameters.extraParams;
...
var StorageHelper = /*#__PURE__*/function () {
  ...
  createClass_default()(StorageHelper, [{
    ...
    value: function () {
      var _storeLoginDetails = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(params, scope) {
    ...
    value: function () {
      var _retrieveLoginDetails = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(scope) {
...
var CustomAuth = /*#__PURE__*/function () {
  ...
  createClass_default()(CustomAuth, [{
      ...
      var _init = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee() {
        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref2 = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref2$skipSw = _ref2.skipSw, skipSw = _ref2$skipSw === void 0 ? false : _ref2$skipSw, _ref2$skipInit = _ref2.skipInit, skipInit = _ref2$skipInit === void 0 ? false : _ref2$skipInit, _ref2$skipPrefetch = _ref2.skipPrefetch, skipPrefetch = _ref2$skipPrefetch === void 0 ? false : _ref2$skipPrefetch;
    ...
    key: "triggerLogin",
    value: function () {
      var _triggerLogin = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee2(args) {
        var verifier, typeOfLogin, clientId, jwtParams, hash, queryParameters, customState, registerOnly, loginHandler, loginParams, _handleRedirectParame, error, hashParameters, instanceParameters, accessToken, idToken, rest, userInfo, nodeTx, _yield$this$nodeDetai, torusNodeEndpoints, torusNodePub, lookupTx, torusPubKey, res, _torusKey, torusKey;
        return regenerator_default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                verifier = args.verifier, typeOfLogin = args.typeOfLogin, clientId = args.clientId, jwtParams = args.jwtParams, hash = args.hash, queryParameters = args.queryParameters, customState = args.customState, registerOnly = args.registerOnly;
              ...
              case 6:
                ...
                _handleRedirectParame = handleRedirectParameters(hash, queryParameters), error = _handleRedirectParame.error, hashParameters = _handleRedirectParame.hashParameters, instanceParameters = _handleRedirectParame.instanceParameters;
                if (!error) {
                  _context2.next = 11;
                  break;
                }
              ...
              case 11:
                accessToken = hashParameters.access_token, idToken = hashParameters.id_token, rest = objectWithoutProperties_default()(hashParameters, login_excluded); // State has to be last here otherwise it will be overwritten
              ...
              case 31:
                ...
                _context2.next = 38;
                return this.torus.getPublicAddress(torusNodeEndpoints, torusNodePub, {
                  verifier: verifier,
                  verifierId: userInfo.verifierId
                }, true);
              case 38:
              ...
              case 45:
                _context2.next = 47;
                return this.getTorusKey(verifier, userInfo.verifierId, {
                  verifier_id: userInfo.verifierId
                }, loginParams.idToken || loginParams.accessToken, userInfo.extraVerifierParams);
              case 47:
                torusKey = _context2.sent;
                return _context2.abrupt("return", login_objectSpread(login_objectSpread({}, torusKey), {}, {
                  userInfo: login_objectSpread(login_objectSpread({}, userInfo), loginParams)
                }));
              case 49:
              case "end":
    ...
    value: function () {
      var _triggerAggregateLogin = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee3(args) {
        var aggregateVerifierType, verifierIdentifier, subVerifierDetailsArray, userInfoPromises, loginParamsArray, _iterator, _step, subVerifierDetail, clientId, typeOfLogin, verifier, jwtParams, hash, queryParameters, customState, loginHandler, _loginParams, _handleRedirectParame2, error, hashParameters, instanceParameters, _accessToken, _idToken, rest, _userInfoArray, userInfoArray, aggregateVerifierParams, aggregateIdTokenSeeds, aggregateVerifierId, extraVerifierParams, index, loginParams, idToken, accessToken, userInfo, aggregateIdToken, torusKey;
        return regenerator_default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                // This method shall break if any of the promises fail. This behaviour is intended
                aggregateVerifierType = args.aggregateVerifierType, verifierIdentifier = args.verifierIdentifier, subVerifierDetailsArray = args.subVerifierDetailsArray;
                if (this.isInitialized) {
                  _context3.next = 3;
                  break;
                }
              ...
              case 12:
                ...
                clientId = subVerifierDetail.clientId, typeOfLogin = subVerifierDetail.typeOfLogin, verifier = subVerifierDetail.verifier, jwtParams = subVerifierDetail.jwtParams, hash = subVerifierDetail.hash, queryParameters = subVerifierDetail.queryParameters, customState = subVerifierDetail.customState;
                loginHandler = HandlerFactory({
                  typeOfLogin: typeOfLogin,
                  clientId: clientId,
                  verifier: verifier,
                ...
                _handleRedirectParame2 = handleRedirectParameters(hash, queryParameters), error = _handleRedirectParame2.error, hashParameters = _handleRedirectParame2.hashParameters, instanceParameters = _handleRedirectParame2.instanceParameters;
                if (!error) {
                  _context3.next = 21;
                  break;
                }
                throw new Error(error);
              case 21:
                _accessToken = hashParameters.access_token, _idToken = hashParameters.id_token, rest = objectWithoutProperties_default()(hashParameters, _excluded2); // State has to be last here otherwise it will be overwritten
                _loginParams = login_objectSpread(login_objectSpread({
              ...
              case 48:
                ...
                userInfoArray = _userInfoArray.map(function (userInfo) {
                  return login_objectSpread(login_objectSpread({}, userInfo), {}, {
                ...
                aggregateIdToken = (0,external_web3_utils_namespaceObject.keccak256)(aggregateIdTokenSeeds.join(String.fromCharCode(29))).slice(2);
                aggregateVerifierParams.verifier_id = aggregateVerifierId;
                _context3.next = 60;
                return this.getTorusKey(verifierIdentifier, aggregateVerifierId, aggregateVerifierParams, aggregateIdToken, extraVerifierParams);
              case 60:
                torusKey = _context3.sent;
                return _context3.abrupt("return", login_objectSpread(login_objectSpread({}, torusKey), {}, {
    ...
    value: function () {
      var _triggerHybridAggregateLogin = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee4(args) {
        var singleLogin, aggregateLoginParams, typeOfLogin, clientId, verifier, jwtParams, hash, queryParameters, customState, loginHandler, loginParams, _handleRedirectParame3, error, hashParameters, instanceParameters, accessToken, idToken, rest, userInfo, torusKey1Promise, verifierIdentifier, subVerifierDetailsArray, aggregateVerifierParams, aggregateIdTokenSeeds, aggregateVerifierId, index, sub, _loginParams2, _idToken2, _accessToken2, aggregateIdToken, torusKey2Promise, _yield$Promise$all, _yield$Promise$all2, torusKey1, torusKey2;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                ...
                throw new Error("Single id verifier can only have one sub verifier");
              case 7:
                typeOfLogin = singleLogin.typeOfLogin, clientId = singleLogin.clientId, verifier = singleLogin.verifier, jwtParams = singleLogin.jwtParams, hash = singleLogin.hash, queryParameters = singleLogin.queryParameters, customState = singleLogin.customState;
                loginHandler = HandlerFactory({
                  typeOfLogin: typeOfLogin,
                  clientId: clientId,
                  verifier: verifier,
                ...
                _handleRedirectParame3 = handleRedirectParameters(hash, queryParameters), error = _handleRedirectParame3.error, hashParameters = _handleRedirectParame3.hashParameters, instanceParameters = _handleRedirectParame3.instanceParameters;
                if (!error) {
                  _context4.next = 13;
                  break;
                }
                throw new Error(error);
              case 13:
                accessToken = hashParameters.access_token, idToken = hashParameters.id_token, rest = objectWithoutProperties_default()(hashParameters, _excluded3); // State has to be last here otherwise it will be overwritten
                loginParams = login_objectSpread(login_objectSpread({
                  accessToken: accessToken,
                  idToken: idToken
                }, rest), {}, {
              ...
              case 28:
                ...
                torusKey1Promise = this.getTorusKey(verifier, userInfo.verifierId, {
                  verifier_id: userInfo.verifierId
                }, loginParams.idToken || loginParams.accessToken, userInfo.extraVerifierParams);
                verifierIdentifier = aggregateLoginParams.verifierIdentifier, subVerifierDetailsArray = aggregateLoginParams.subVerifierDetailsArray;
                aggregateVerifierParams = {
                  verify_params: [],
                  sub_verifier_ids: [],
                  verifier_id: ""
                ...
                aggregateIdToken = (0,external_web3_utils_namespaceObject.keccak256)(aggregateIdTokenSeeds.join(String.fromCharCode(29))).slice(2);
                aggregateVerifierParams.verifier_id = aggregateVerifierId;
                torusKey2Promise = this.getTorusKey(verifierIdentifier, aggregateVerifierId, aggregateVerifierParams, aggregateIdToken, userInfo.extraVerifierParams);
                _context4.next = 41;
    ...
    key: "getTorusKey",
    value: function () {
      var _getTorusKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee5(verifier, verifierId, verifierParams, idToken, additionalParams) {
        var nodeTx, _yield$this$nodeDetai2, torusNodeEndpoints, torusNodePub, torusIndexes, pubLookupTx, address, sharesTx, shares;
        return regenerator_default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                _yield$this$nodeDetai2 = _context5.sent;
                torusNodeEndpoints = _yield$this$nodeDetai2.torusNodeEndpoints;
                torusNodePub = _yield$this$nodeDetai2.torusNodePub;
                torusIndexes = _yield$this$nodeDetai2.torusIndexes;
                this.sentryHandler.finishTransaction(nodeTx);
    ...
    value: function () {
      var _getAggregateTorusKey = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee6(verifier, verifierId,
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                return _context6.abrupt("return", this.getTorusKey(verifier, verifierId, aggregateVerifierParams, aggregateIdToken, extraVerifierParams));
              case 8:
              case "end":
    ...
    value: function () {
      var _getRedirectResult = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee7() {
        var _ref3,
          _ref3$replaceUrl,
          replaceUrl,
        ...
        return regenerator_default().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ref3 = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : {}, _ref3$replaceUrl = _ref3.replaceUrl, replaceUrl = _ref3$replaceUrl === void 0 ? true : _ref3$replaceUrl, _ref3$clearLoginDetai = _ref3.clearLoginDetails, clearLoginDetails = _ref3$clearLoginDetai === void 0 ? true : _ref3$clearLoginDetai;
                _context7.next = 3;
                return this.init({
                  skipInit: true
                });
              ...
              case 10:
                _handleRedirectParame4 = handleRedirectParameters(hash, queryParams), error = _handleRedirectParame4.error, instanceParameters = _handleRedirectParame4.instanceParameters, hashParameters = _handleRedirectParame4.hashParameters;
              ...
              case 50:
                ...
                return _context7.abrupt("return", login_objectSpread({
                  error: "Could not get result from torus nodes \n ".concat((_context7.t0 === null || _context7.t0 === void 0 ? void 0 : _context7.t0.message) || ""),
                  state: instanceParameters || {},
                  method: method,
                  result: {},
                  hashParameters: hashParameters,
    ...
    value: function () {
      var _handlePrefetchRedirectUri = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee8() {
        var _this = this;
                    ...
                    if (redirectHtml.relList && redirectHtml.relList.supports) {
                      if (redirectHtml.relList.supports("prefetch")) {
                        ...
                        redirectHtml.onerror = function () {
                          reject(new Error("Please serve redirect.html present in serviceworker folder of this package on ".concat(_this.config.redirect_uri)));
                        };
