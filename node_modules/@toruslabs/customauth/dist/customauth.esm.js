...
var CONTRACT_MAP = (_CONTRACT_MAP = {}, _defineProperty(_CONTRACT_MAP, TORUS_NETWORK.MAINNET, NodeDetailManager.PROXY_ADDRESS_MAINNET), _defineProperty(_CONTRACT_MAP, TORUS_NETWORK.TESTNET, NodeDetailManager.PROXY_ADDRESS_TESTNET), _defineProperty(_CONTRACT_MAP, TORUS_NETWORK.CYAN, NodeDetailManager.PROXY_ADDRESS_CYAN), _defineProperty(_CONTRACT_MAP, TORUS_NETWORK.AQUA, NodeDetailManager.PROXY_ADDRESS_AQUA), _defineProperty(_CONTRACT_MAP, TORUS_NETWORK.CELESTE, NodeDetailManager.PROXY_ADDRESS_CELESTE), _CONTRACT_MAP);
var SIGNER_MAP = (_SIGNER_MAP = {}, _defineProperty(_SIGNER_MAP, TORUS_NETWORK.MAINNET, "https://signer.tor.us"), _defineProperty(_SIGNER_MAP, TORUS_NETWORK.TESTNET, "https://signer.tor.us"), _defineProperty(_SIGNER_MAP, TORUS_NETWORK.CYAN, "https://signer-polygon.tor.us"), _defineProperty(_SIGNER_MAP, TORUS_NETWORK.AQUA, "https://signer-polygon.tor.us"), _defineProperty(_SIGNER_MAP, TORUS_NETWORK.CELESTE, "https://signer-polygon.tor.us"), _SIGNER_MAP);
var SENTRY_TXNS = {
...
var loginToConnectionMap = (_loginToConnectionMap = {}, _defineProperty(_loginToConnectionMap, LOGIN.APPLE, "apple"), _defineProperty(_loginToConnectionMap, LOGIN.GITHUB, "github"), _defineProperty(_loginToConnectionMap, LOGIN.LINKEDIN, "linkedin"), _defineProperty(_loginToConnectionMap, LOGIN.TWITTER, "twitter"), _defineProperty(_loginToConnectionMap, LOGIN.WEIBO, "weibo"), _defineProperty(_loginToConnectionMap, LOGIN.LINE, "line"), _defineProperty(_loginToConnectionMap, LOGIN.EMAIL_PASSWORD, "Username-Password-Authentication"), _defineProperty(_loginToConnectionMap, LOGIN.PASSWORDLESS, "email"), _loginToConnectionMap);
        ...
        return new Promise(function (resolve, reject) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      _ref2 = data || {}, instanceParams = _ref2.instanceParams, _ref2$hashParams = _ref2.hashParams, accessToken = _ref2$hashParams.access_token, idToken = _ref2$hashParams.id_token, rest = _objectWithoutProperties(_ref2$hashParams, _excluded$2);
                      if (!error) {
                        _context.next = 7;
                        break;
                      }
          ...
          if (!_this.redirectToOpener) {
            ...
            var postMessageEventHandler = /*#__PURE__*/function () {
              var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(postMessageEvent) {
                var ev;
...
var DiscordHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  _createClass(DiscordHandler, [{
    ...
    key: "getUserInfo",
    value: function () {
      var _getUserInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(params) {
    ...
    value: function handleLoginWindow() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        try {
          ...
          post(_this2.finalURL.href, JSON.parse(JSON.stringify(finalJwtParams))).then(function (response) {
...
var WebAuthnHandler = /*#__PURE__*/function (_AbstractLoginHandler) {
  ...
  _createClass(WebAuthnHandler, [{
    ...
    key: "getUserInfo",
    value: function () {
      var _getUserInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(parameters) {
...
var StorageHelper = /*#__PURE__*/function () {
  ...
  _createClass(StorageHelper, [{
    ...
    value: function () {
      var _storeLoginDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(params, scope) {
    ...
    value: function () {
      var _retrieveLoginDetails = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(scope) {
...
var CustomAuth = /*#__PURE__*/function () {
  ...
  _createClass(CustomAuth, [{
    ...
    key: "triggerLogin",
    value: function () {
      var _triggerLogin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(args) {
        ...
        return _regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                accessToken = hashParameters.access_token, idToken = hashParameters.id_token, rest = _objectWithoutProperties(hashParameters, _excluded); // State has to be last here otherwise it will be overwritten
              ...
              case 47:
                ...
                return _context2.abrupt("return", _objectSpread(_objectSpread({}, torusKey), {}, {
                  userInfo: _objectSpread(_objectSpread({}, userInfo), loginParams)
                }));
              case 49:
              case "end":
    ...
    value: function () {
      var _triggerAggregateLogin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(args) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 12:
                ...
                throw new Error(error);
              case 21:
                _accessToken = hashParameters.access_token, _idToken = hashParameters.id_token, rest = _objectWithoutProperties(hashParameters, _excluded2); // State has to be last here otherwise it will be overwritten
                _loginParams = _objectSpread(_objectSpread({
              ...
              case 60:
                ...
                return _context3.abrupt("return", _objectSpread(_objectSpread({}, torusKey), {}, {
    ...
    value: function () {
      var _triggerHybridAggregateLogin = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(args) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                ...
                throw new Error(error);
              case 13:
                accessToken = hashParameters.access_token, idToken = hashParameters.id_token, rest = _objectWithoutProperties(hashParameters, _excluded3); // State has to be last here otherwise it will be overwritten
                loginParams = _objectSpread(_objectSpread({
                  accessToken: accessToken,
                  idToken: idToken
                }, rest), {}, {
    ...
    key: "getTorusKey",
    value: function () {
      var _getTorusKey = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(verifier, verifierId, verifierParams, idToken, additionalParams) {
    ...
    value: function () {
      var _getAggregateTorusKey = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(verifier, verifierId,
    ...
    value: function () {
      var _getRedirectResult = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
        var _ref3,
          _ref3$replaceUrl,
          replaceUrl,
    ...
    value: function () {
      var _handlePrefetchRedirectUri = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
        var _this = this;
...
export { AGGREGATE_VERIFIER, CONTRACT_MAP, LOGIN, REDIRECT_PARAMS_STORAGE_METHOD, SENTRY_TXNS, SIGNER_MAP, TORUS_METHOD, UX_MODE, are3PCSupported, broadcastChannelOptions, constructURL, createHandler, CustomAuth as default, eventToPromise, getPopupFeatures, getVerifierId, handleRedirectParameters, isFirefox, loginToConnectionMap, padUrlString, randomId, storageAvailable, validateAndConstructUrl };
